...
const translations: Translations = {
  en: {
    ...
    // Add update page translations
    "update.title": "Update Schedule",
    "update.howItWorks": "How It Works",
    "update.updates": "Updates",
    "update.updatesDesc":
      "Changes made here are saved directly to secure storage and are immediately available on the site.",
    "update.security": "Security",
    "update.securityDesc": "Schedule data is stored securely, improving privacy and security.",
    "update.error": "Error",
    "update.success": "Success",
    "update.viewUpdated": "View Updated Schedule",
    "update.viewUpdatedLink": "Click here to view the updated schedule",
    "update.selectSchedule": "Select Schedule",
    "update.year": "Year",
    "update.group": "Group",
    "update.language": "Language",
    "update.loading": "Loading...",
    "update.loadSchedule": "Load Schedule",
    "update.editSchedule": "Edit Schedule",
    "update.scheduleContent": "Schedule Content",
    "update.saving": "Saving...",
    "update.saveSchedule": "Save Schedule",
    "update.downloadSchedule": "Download Schedule",
    "update.authRequired": "Authentication Required",
    "update.enterPassword": "Please enter the admin password to continue",
    "update.password": "Password",
    "update.authenticating": "Authenticating...",
    "update.authenticate": "Authenticate",
    "update.fileLoaded": "Schedule loaded successfully: {fileName}",
    "update.fileSaved": "File edited and saved successfully: {fileName}",
  },
  ru: {
    ...
    // Add update page translations
    "update.title": "Обновить расписание",
    "update.howItWorks": "Как это работает",
    "update.updates": "Обновления",
    "update.updatesDesc":
      "Изменения, внесенные здесь, сохраняются непосредственно в безопасном хранилище и сразу доступны на сайте.",
    "update.security": "Безопасность",
    "update.securityDesc": "Данные расписания хранятся в безопасном месте, повышая конфиденциальность и безопасность.",
    "update.error": "Ошибка",
    "update.success": "Успех",
    "update.viewUpdated": "Просмотреть обновленное расписание",
    "update.viewUpdatedLink": "Нажмите здесь, чтобы просмотреть обновленное расписание",
    "update.selectSchedule": "Выбрать расписание",
    "update.year": "Год",
    "update.group": "Группа",
    "update.language": "Язык",
    "update.loading": "Загрузка...",
    "update.loadSchedule": "Загрузить расписание",
    "update.editSchedule": "Редактировать расписание",
    "update.scheduleContent": "Содержание расписания",
    "update.saving": "Сохранение...",
    "update.saveSchedule": "Сохранить расписание",
    "update.downloadSchedule": "Скачать расписание",
    "update.authRequired": "Требуется аутентификация",
    "update.enterPassword": "Пожалуйста, введите пароль администратора для продолжения",
    "update.password": "Пароль",
    "update.authenticating": "Аутентификация...",
    "update.authenticate": "Войти",
    "update.fileLoaded": "Расписание успешно загружено: {fileName}",
    "update.fileSaved": "Файл успешно отредактирован и сохранен: {fileName}",
  },
}
